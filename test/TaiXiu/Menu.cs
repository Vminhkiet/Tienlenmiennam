...
namespace TaiXiu
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string tentk, decimal tien, int phongvao = 0)
        {
            InitializeComponent();
        ...
        void Connect()
        {                 
            IP = new IPEndPoint(IPAddress.Parse("192.168.188.219"), 8888);
        ...
        void Recieve()
        {
            while (true)
            {
                try
                {
                    ...
                    {
                        richTextBox1.Focus();
                        richTextBox1.Text += chuoi[1] + ":" + chuoi[2] + "\n";
                    }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "Tiền: " + Tien.ToString();
            textBox3.Text = tentkhoan;
        ...
        {
            string a = "Msg-" + tentkhoan + "-" + textBox2.Text;
