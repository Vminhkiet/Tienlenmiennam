...
namespace TaiXiu
{
    public partial class Game : Form
    {
        ...
        System.Media.SoundPlayer Chatheo = new System.Media.SoundPlayer();
        #endregion
        List<int> doithu;
        ...
        #endregion
        #region event handle
        List<Mysprites> sprites;
        int nSprites;
        private void Game_Load(object sender, EventArgs e)
        {
            kryptonPictureBox2.Hide();
            kryptonPictureBox3.Hide();
            kryptonPictureBox4.Hide();
            win1.Hide();
            win2.Hide();
            win3.Hide();
            win4.Hide();
            ...
            string tiendung = Player.Tien.ToString();
            setava14(tiendung);
            label10.Hide();
            label11.Hide();
            label12.Hide();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (!dangchoi)
            {
                ...
                Thread thread = new Thread(() =>
                {
                    Form1 f = new Form1(Player.taitk, Player.tien, port);
                    // Hiển thị Form1
                    f.ShowDialog();
                });
                this.Close();
        ...
        {
            string a = "Msg-"+Player.hoten+"-" + textBox1.Text;
        ...
        void Connect()
        {
            IP = new IPEndPoint(IPAddress.Parse("192.168.188.219"), port);
                ...
                while (true)
                {
                    ...
                    if (strings[0].CompareTo("STT") == 0)
                    {
                        ...
                        for (int i = 5; i < strings.Length; i++)
                        {
                            ...
                            string tiendung = tt[1];
                            tt[1] = xulytien1(decimal.Parse(tt[1]));
                    ...
                    else if (strings[0].CompareTo("PhatBai") == 0)
                    {
                        ...
                        turn = int.Parse(strings[strings.Length - 1]);
                        label1.Show();
                        button4.Show();
                        isFirstTurn = true;
                    ...
                    else if (strings[0].CompareTo("ThongTinBai") == 0)
                    {
                        ...
                        else if (Ttype.Contains("Doi Thong"))
                        {
                            ...
                            pictureBox18.Show();
                            Chatheo.SoundLocation = "chatheo.wav";
                            Chatheo.Play();
                    ...
                    {
                        richTextBox1.Focus();
                        richTextBox1.Text += strings[1] + ":" + strings[2]+"\n";
